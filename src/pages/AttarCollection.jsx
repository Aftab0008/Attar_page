            ...
            {attars.map(([name, p3, p6], index) => (
              <div key={index} className="p-6 rounded-2xl border border-white/20 bg-white/10 backdrop-blur-md shadow-xl relative overflow-hidden transition-transform transform hover:scale-105">
                ...
                <div className="text-center">
                  <a href="https://wa.me/9304109387" target="_blank" rel="noopener noreferrer" className="inline-block mt-4 px-4 py-2 bg-gradient-to-r from-pink-600 to-purple-700 text-white rounded-lg hover:from-pink-700 hover:to-purple-800 transition">
                    Order on WhatsApp
                  </a>
                </div>
              </div>
